        ...
        <div class="row">
          ...
          >
            ...
            <li class="list-inline-item">
              <a
                class="categories border d-block text-dark rounded"
                @click="updateFilter('branding')"
                :class="{ active: filterCategory == 'branding' }"
                >Branding</a
              >
            </li>
            <li class="list-inline-item">
            ...
            <li class="list-inline-item">
              <a
                class="categories border d-block text-dark rounded"
                @click="updateFilter('photography')"
            ...
            <li class="list-inline-item">
              <a
                class="categories border d-block text-dark rounded"
                @click="updateFilter('development')"
