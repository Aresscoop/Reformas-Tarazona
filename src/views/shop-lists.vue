              ...
              <div class="page-next">
                <nav aria-label="breadcrumb" class="d-inline-block">
                  <ul class="breadcrumb bg-white rounded shadow mb-0">
                    ...
                    <li class="breadcrumb-item">
                      <router-link tag="a" to="/index-shop">Shop</router-link>
                    </li>
              ...
              <div class="card-body p-0">
                ...
                <div class="widget mt-4 pt-2">
                  ...
                  <ul class="list-unstyled mt-4 mb-0 blog-categories">
                    ...
                    <li><a href="javascript:void(0);">Kid’s Wear</a></li>
                  ...
                  <ul class="list-unstyled mt-4 mb-0">
                    <li class="list-inline-item">
                      <a
                        ...
                        class="btn btn-sm btn-icon btn-pills btn-primary"
                    ...
                    <li class="list-inline-item">
                      <a
                        href="javascript:void(0)"
                        class="btn btn-sm btn-icon btn-pills btn-danger ml-1"
                        ><span class="d-none">.</span></a
                      >
                    </li>
                    <li class="list-inline-item">
                      <a
                        href="javascript:void(0)"
                        class="btn btn-sm btn-icon btn-pills btn-success ml-1"
                        ><span class="d-none">.</span></a
                      >
                    </li>
                    <li class="list-inline-item">
                      <a
                        href="javascript:void(0)"
                        class="btn btn-sm btn-icon btn-pills btn-info ml-1"
                        ><span class="d-none">.</span></a
                      >
                    </li>
                    <li class="list-inline-item">
                    ...
                    <li class="list-inline-item">
                      <a
                        href="javascript:void(0)"
                        class="btn btn-sm btn-icon btn-pills btn-warning ml-1"
                        ><span class="d-none">.</span></a
                      >
                    </li>
                  </ul>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg-4 col-md-5 mt-4 mt-sm-0 pt-2 pt-sm-0">
                ...
                >
                  ...
                  <div>
                    <router-link to="/shop-lists" tag="a" class="h5 text-muted"
                    ...
                    <div class="col-lg-4 col-md-6">
                      <div class="shop-image position-relative overflow-hidden">
                        ...
                        <div class="overlay-work">
                          <div
                            class="py-2 bg-soft-dark rounded-bottom out-stock"
                          >
                    ...
                    <div class="col-lg-8 col-md-6">
                      <div class="card-body content p-4">
                        ...
                        <div class="d-lg-flex align-items-center mt-2 mb-3">
                          <h6 class="text-muted small font-italic mb-0 mr-3">
                ...
                <ul class="pagination justify-content-center mb-0">
                  <li class="page-item">
                    <a
                      ...
                      href="javascript:void(0)"
                      aria-label="Previous"
                      ><i class="mdi mdi-arrow-left"></i> Prev</a
                    >
                  </li>
